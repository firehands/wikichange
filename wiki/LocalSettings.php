...
$wgEmergencyContact = "admin@wikichange.org";
$wgPasswordSender = "admin@wikichange.org";
...
## Database settings
# (This file is not available on github for obvious reasons.)
...
# this enables the SMW extension
include_once("$IP/extensions/SemanticMediaWiki/SemanticMediaWiki.php");
enableSemantics('wikichange.org');
